...
public class ActivityInference {
    ...
    private static final int OUTPUT_SIZE = 2;// this will give probability of speech+noise or noise , since we are using softmax activity function instead of for example sigmoid
