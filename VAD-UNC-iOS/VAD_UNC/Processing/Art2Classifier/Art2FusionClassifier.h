...
typedef struct Art2FusionParallel {
    ...
    int firstFrame;
    int NewClusterCreationBufferSize; // new clster creation buffer
...
Art2FusionParallel* initArt2ParallelFusion(int SavingClusteringDataSwitch,
                                          ...
                                          int MaxClusterNum);
void computeArt2ParallelFusion(Art2FusionParallel* Art2Fusion,float* ExtractedFeaturesList, const char* className);
